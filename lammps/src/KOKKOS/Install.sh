...
action angle_quartic_kokkos.cpp angle_quartic.cpp
action angle_quartic_kokkos.h angle_quartic.h
...
action fix_bond_break_kokkos.cpp fix_bond_break.cpp
action fix_bond_break_kokkos.h fix_bond_break.h
